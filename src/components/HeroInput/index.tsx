...
export default function HeroInput() {
  return (
    ...
    >
      <p
        className={`${lora.className} text-lg xl:text-2xl 3xl:text-3xl text-white pl-10 pt-4 xl:pt-10 `}
      >
        {' '}
      ...
      <div
        className={`${lato.className} px-10 pt-4 xl:pt-10 space-y-4 3xl:text-lg 3xl:space-y-8`}
      >
      ...
      <div
        className={`${lato.className} px-10 mt-6 xl:mt-10 flex justify-center items-center`}
      >
