    ...
    <div className={` bg-[#10375C] w-full  lg:h-[240px]`}>
      <div className="max-w-[1062px] px-6 md:px-10 py-10 mx-auto text-white flex justify-between items-center">
        ...
        <Button
          ...
          name="Subscribe"
          className="bg-white shadow-sm inline-flex shadow-[#10375ce2] text-[#10375C] px-3 py-1 rounded-[40px] hover:bg-[#69b5fc] transition-all duration-100 ease-in-out hover:text-white"
          type="button"
        />
